  ...
  return (
    <HomeLayout>
      <div className="pl-20 pt-20 flex flex-col text-white">
        <div className="flex items-center gap-5 mx-10 my-12">
          ...
          <div id="slide1" className="carousel-item relative w-full">
            <div className="flex flex-col items-center justify-center gap-4 rounded-full">
              ...
              <p className="text-xl text-gray-400">
                “It is important to follow your dreams and heart. Do something
                that excites you.”
              </p>
            ...
            <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
              <li>
                ...
                <div className="timeline-start mb-10 text-end text-gray-400 hover:text-gray-200">
                  ...
                  We are committed to staying at the forefront of e-learning
              ...
              <li>
                ...
                <div className="timeline-end mb-10 text-left text-gray-400 hover:text-gray-200">
                  ...
                  We prioritize high standards of content and instruction,
                  ensuring that every learner receives the best possible
              ...
              <li>
                ...
                <div className="timeline-start mb-10 text-end text-gray-400 hover:text-gray-200">
                  ...
                  accessible from any device, ensuring that you can study
              ...
              <li>
                ...
                <div className="timeline-end mb-10 text-left text-gray-400 hover:text-gray-200">
                  ...
                  Our platform offers cost-effective solutions without
                  compromising on the quality of learning.
                </div>
                <hr />
              </li>
              <li>
                ...
                <div className="timeline-start mb-10 text-end text-gray-400 hover:text-gray-200">
                  ...
                  Join a vibrant community of learners and educators. Our
                  dedicated support team is always here to assist you, ensuring
